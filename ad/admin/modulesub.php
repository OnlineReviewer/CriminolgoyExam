  ...
  <ul class="navbar-nav">
     ...
     <ul class="navbar-nav ml-auto">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
           <a class="nav-link" href="modulesub.php?logout=<?php echo $row['logout'];?>">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12">
                      ...
                      <input name="subid" type="text" value="<?php echo $subid;?>" class="form-control" placeholder="ex. 123-23432-12" hidden>
                       ...
                       <div class="col-md-12">
                       <div class="form-group">
                         <label for="exampleInputEmail1" class="float-left">Select a Module (PDF only):</label>
                         <input name="learnM" type="file" class="form-control" value=" " accept=".pdf">
                       </div>
                    </div>
         ...
         <div class="modal-content">
            <div class="modal-body text-center">
                <form  method="POST" action="add/save_video.php"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12">
                      ...
                      <input name="subid" type="text" value="<?php echo $subid;?>" class="form-control" placeholder="ex. 123-23432-12" hidden>
                       ...
                       <div class="col-md-12">
                       <div class="form-group">
                         <label for="exampleInputEmail1" class="float-left">Select a Video (MP4 only):</label>
                         <input name="video" type="file" class="form-control"value=" " accept=".mp4" onchange="validateFile()">
                       </div>
                    </div>
                  ...
                  <div class="card-footer">
                     <button type="submit" name="submit" value= "Submit"class="btn bg2" id="submitButton" >Save</button>
                     <a href="modulesub.php?subid=<?php echo $_GET['subid'];?>" class="btn bg1">Cancel</a>
                  </div>
                </form>
            </div>
      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-book"></span>Learning Materials</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        while($row = $result->fetch_array(MYSQLI_ASSOC))
                        {
                           ...
                           ?>
                       <tr>
                           <td><a href="documents/doc.php?learnmid=<?php echo $row['learnmid'];?>"><i class="fa fa-edit"></i> <?php echo $row['module']; ?> </a><a  href="moduleAvideo.php?video=<?php echo $row['video'];?>"><?php echo $row['video']; ?></a></td>
...
{?>
  ...
  <div class="popup__content">
  <h3 class="popup__content__title">
  <h3>Are you sure want to delete this Learning Materials?</h3>
  <div class="m-t-20"> <a href="subject.php" class="btn btn-white">Close</a>
