...
$que="SELECT * FROM `class` WHERE classid='".$_GET["classid"]."'";
        ...
        <div class="popup popup--icon -question js_question-popup popup--visible">
         <div class="popup__background"></div>
          <div class="popup__content">
                  <!-- form start -->
                  <form method="POST" action="updating_class.php"  enctype="multipart/form-data">
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-12">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="classname" value="<?php echo $classname; ?>"  class="form-control" placeholder="ex. Correctional Administration">
                                       <input name="classid" type="text" value="<?php echo $classid; ?>" class="form-control" placeholder="middle name" hidden>
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Description</label>
                                       <input name="description" value="<?php echo $description; ?>" class="form-control">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
