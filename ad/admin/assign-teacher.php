...
if(isset($_GET['teacherfname']))
{?>
  <div class="popup popup--icon -question js_question-popup popup--visible">
  <div class="popup__background"></div>
  <div class="popup__content">
  <h3 class="popup__content__title">
  <h3>Are you sure want to delete this assign - teacher?</h3>
  <div class="m-t-20"> <a href="assign-teacher.php" class="btn btn-white">Close</a>
    <a href="delete/del_assignt.php?teacherfname=<?php echo $_GET['teacherfname']; ?>" class="btn btn-white" >
  ...
  <ul class="navbar-nav">
     ...
     <ul class="navbar-nav ml-auto">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
           <a class="nav-link" href="assign-teacher.php?logout=<?php echo $row['logout'];?>">
            ...
            <div class="container-fluid">
               <div class="card card-info">
                  <div class="card-body">
                     ...
                     class="fa fa-user-plus"></i> Add Assign Teacher</a><br><br>    
               <div class="col-md-12 table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        <?php 
                        $sql = "SELECT DISTINCT teacherfname FROM `assignteacher`";
                        ...
                        while ($teacherRow = $result->fetch_array(MYSQLI_ASSOC)) {
                            ...
                            $classSql = "SELECT class.classname , assignteacher.id
                                        FROM `assignteacher`
                        ...
                        ?>
                            <tr>
                                <td><?php echo $teacherfname; ?></td>
                                <td>
                                    <?php 
                                    while ($classRow = $classResult->fetch_array(MYSQLI_ASSOC)) {
                                        echo $classRow['classname'] . '<br>';
                                    }
                                    ?>
                                </td>
                                <td class="text-right">
                                                            <a class="btn btn-sm bg3" href="edit/edit_assignt.php?teacherfname=<?php echo $teacherfname; ?>"><i class="fa fa-edit"></i> edit</a>
                                                            <a class="btn btn-sm bg1" href="assign-teacher.php?teacherfname=<?php echo $teacherfname; ?>"><i class="fa fa-trash-alt"></i> delete</a>
                                                        </td>
                            </tr>
                        <?php  
                        } 
