  ...
  <ul class="navbar-nav">
     ...
     <ul class="navbar-nav ml-auto">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
           <a class="nav-link" href="subjectquiz.php?logout=<?php echo $row['logout'];?>">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> <a  href="quiz.php?subid=<?php echo $row['subid'];?>" ><i class="fa fa-edit"></i>QUIZ</a></td>
                            
                                   
                           <td> <?php 
                                   
                                   $sql3 = "SELECT * FROM  `assignteacher` where subjectid = $subid";
