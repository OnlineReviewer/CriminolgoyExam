...
$que="SELECT * FROM `announcement` WHERE anid='".$_GET["anid"]."'";
        ...
        <div class="popup popup--icon -question js_question-popup popup--visible">
         <div class="popup__background"></div>
          <div class="popup__content">
                  <!-- form start -->
                  <form method="POST" action="updating_announce.php"  enctype="multipart/form-data">
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-12">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Title</label>
                                        <input type="text" name="title" value="<?php echo $title ?>" class="form-control" placeholder="ex. Exam Date">
                                          <input type="text" name="anid" value="<?php echo $anid ?>" class="form-control" placeholder="ex. Exam Date" hidden>
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Description</label>
                                        <input name="desc" value="<?php echo $description; ?>" class="form-control" placeholder="ex.Prepare for the upcoming exam ">
                                    </div>
                                 </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Date</label>
                                        <input type="date" value="<?php echo $dates; ?>" name="date"  class="form-control">
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Time</label>
                                        <input type="time" value="<?php echo $tim; ?>" name="time"  class="form-control">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
                                <button type="submit" name="submit" class="btn bg2">Save</button>
                                  <a class="btn bg1" href="../announcement.php" >Cancel</a>
                              </div>
                  </form>
               </div>
             </div></div>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-right">
                              <a class="btn btn-sm bg3" href="edit/edit_announce.php?anid=<?php echo $row['anid'];?>"><i class="fa fa-edit"></i> edit</a>
