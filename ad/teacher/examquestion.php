...
{?>
  ...
  <h3>Are you sure want to delete this Exam Question?</h3>
  <div class="m-t-20"> <a href="course.php" class="btn btn-white">Close</a>
    <a href="delete/del_exam.php?examid=<?php echo $_GET['examid']; ?>" class="btn btn-white" >
...
<div id="add" class="modal animated rubberBand delete-modal" role="dialog">
      <div class="modal-dialog modal-dialog-centered modal-lg">
         <div class="modal-content">
            <div class="modal-body text-center">
               <form  method="POST" action="add/save_exam.php"  enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                     <div class="col-md-12 float-left">
                        <div class="float-left">
                           <span class="fa fa-user"> Quiz Information</span>
                 </div>
              </div>
                    <?php 
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input name="classid" type="text" value="<?php echo $row['classname'];?>" class="form-control" placeholder="ex. 123-23432-12" disabled>
                    ...
                    <?php 
                        ...
                        {?>
                          ...
                          <input name="examid" type="text" value="<?php echo $row['examid']+1;?>" class="form-control" placeholder="ex. 123-23432-12" hidden>
                    ...
                    <?php   }?>
                     ...
                     <div class="form-group">
                       ...
                       <input name="examques" type="text" class="form-control" placeholder="question" required>
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
                        <label >Option4</label>
                         <input name="options4" type="text" class="form-control" placeholder="option3" required>
                       </div>
                    </div>                 
               ...
               <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-certificate"></span> 
                          <?php $sql = "SELECT * FROM class WHERE classid = $classid";
                          $result = mysqli_query($conn,$sql);
                          $row  = mysqli_fetch_array($result); echo $row['classname'] ?></h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <div class="dropdown-content">
                          ...
                          <p><?php echo "1st Option: ".$row['options1']."<br>2nd Option: ".$row['options2']." <br>3rd Option: ".$row['options3']."<br>4th Option: ".$row['options4'];?></p>
                        ...
                        <?php ?> </div>
                                  ...
                                  <td class="text-right">
                                   ...
                                   <a class="btn btn-sm bg3" href="edit/edit_exam.php?examid=<?php echo $row['examid'];?>"><i class="fa fa-edit"></i> edit</a>
                              <a class="btn btn-sm bg1" href="examquestion.php?examid=<?php echo $row['examid'];?>" >
   ...
   <!-- ./wrapper -->
    ...
    <div id="addexam" class="modal animated rubberBand delete-modal" role="dialog">
               ...
               <form  method="POST" action="add/save_stud.php"  enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                     <div class="col-md-12 float-left">
                        <div class="float-left">
                           <span class="fa fa-user">Exam Information</span>
                 </div>
              </div>
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input name="question" type="text" class="form-control" placeholder="" required>
                          <input name="classid" type="text" class="form-control" placeholder="ex. 123-23432-12" required>
                        </div>
                     </div>
